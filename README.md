...
Chorus 3 is at `3.0.1`. The main Chorus2 surfaces have been ported and packaged as
`webinterface.chorus3`, with the first patch release focused on video detail route parity and
navigation polish.
...
Build or download `webinterface.chorus3-3.0.1.zip`, then install it through Kodi:
...
- `webinterface.chorus3/webinterface.chorus3-3.0.1.zip`
